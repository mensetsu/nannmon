...
public class StatisticsResponse {
	...
	/**
	 * Will update current data with values from parameter if it contains statistics.
	 * @param aggregate contains the statistics for a one second period
	 */
	...
	/**
	 * Calculates and stores the average based on sum and count.
	 * This method must be called after all updates or avg field will remain 0d.
	 */
