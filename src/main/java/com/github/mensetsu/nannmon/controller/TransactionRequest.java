...
public class TransactionRequest {
    ...
    // fields are Objects as it's easier to check when parameters haven't been
    // provided (see isValid())
    private Double amount;
    private Long timestamp;

    /**
     * Simple validation check to ensure parameters have been provided (ie; are not
     * null).
     * 
